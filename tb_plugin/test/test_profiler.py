...
class TestProfiler(unittest.TestCase):
    ...
    def test_memory_curve(self):
        ...
        event_data_gpu = [
            ...
            [105, 1, 0, 11, 5000, 5000, 10240],  # alloc 12
            [106, 1, 0, 11, 3000, 8000, 10240],  # alloc 13
            [205, 1, 0, 11, -5000, 3000, 10240], # free 12
            [401, 1, 0, 11, 1024, 4024, 10240],  # alloc 14
            [499, 1, 0, 11, 4, 4028, 10240],     # alloc 15
            [501, 1, 0, 11, -3000, 1028, 10240], # free 13
            [502, 1, 0, 11, -4, 1024, 10240],    # free 15
            [906, 1, 0, 11, -1024, 0, 10240],    # free 14
        ]
